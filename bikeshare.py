...
CITIES = ['chicago', 'new york', 'washington']
    ...
    # created custom lists for month and day data
...
def get_filters():
    ...
    while True:
       city = input('From these options (Chicago, New York or Washington), which cities do you want to explore ? \n> ').lower()
       if city in CITIES:
           break

    # get user input for month (all, january, february, ... , june)
    month = get_user_input('Great! Please provide us the time (a month name) '\
                    'or just say \'all\' to apply no month filter. \n (e.g. all, january, february, march, april, may, june) \n> ', MONTHS)

    # get user input for day of week (all, monday, tuesday, ... sunday)
    day = get_user_input('Awesome! Just a last bit. Would you mind typing one of the week day you want to analyze?'\
...
def display_data(df):
    ...
    for i in range(0, row_length, 5):
        ...
        yes = input('\nWould you like to examine the particular user trip data? \
...
def main():
    while True:
        ...
        restart = input('\nWould you like to go over again? Enter yes or no.\n')
